...
export default function AiPanel({ activePage }: { activePage?: string }) {
  ...
  return (
    ...
    <div className="local-ai-root" style={{ width, height: '100vh', flexShrink: 0, background: 'var(--ai-panel-bg, #F4F3EE)', borderLeft: '1px solid var(--ai-panel-border, #E6E4DC)', display: 'flex', flexDirection: 'column', minHeight: 0, position: 'relative', overflow: 'hidden' }}>
      {/* 拖拽调整宽度 */}
      <div
